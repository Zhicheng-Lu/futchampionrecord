	...
	<div class="section">
        <div class="container">
			...
			<div class="row">
				...
				for ($i=1; $i < 12; $i++) { 
					echo '
				<div id="position_'.$i.'" class="col-xxl-24 col-xl-30 col-lg-40 col-sm-60" style="border: 1px solid #888888; border-radius: 5px; height: 150px; cursor: pointer;" onclick="open_modal('.$i.')">';
